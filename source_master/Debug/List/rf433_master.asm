...
_0x0:
	...
	.DB  0x45,0x52,0x52,0x55,0x50,0x0,0x20,0x20
	.DB  0x20,0x25,0x78,0x20,0x2D,0x20,0x25,0x78
	.DB  0x20,0xD,0xA,0x0,0x52,0x46,0x34,0x33
	.DB  0x33,0x0,0x6E,0x68,0x69,0x65,0x74,0x20
	.DB  0x64,0x6F,0x3A,0x20,0xD,0xA,0x0,0x6E
	.DB  0x68,0x69,0x65,0x74,0x20,0x64,0x6F,0x20
	.DB  0x54,0x52,0x55,0x59,0x45,0x4E,0x3A,0x20
	.DB  0xD,0xA,0x0
_0x20000:
	.DB  0x52,0x65,0x70,0x65,0x61,0x74,0x65,0x64
	.DB  0x20,0x53,0x74,0x61,0x72,0x74,0x20,0x45
	.DB  0x78,0x65,0x2E,0x0
_0x2000003:
	.DB  0x7
_0x20A0060:
	.DB  0x1
...
; 0000 0041 data=UDR;
	IN   R16,12
; 0000 0042     usart_msg("INTERRUP");
	__POINTW2MN _0x8,0
	RCALL _usart_msg
; 0000 0043     printf("   %x - %x \r\n", rx_buffer[0], rx_buffer[1]);
	__POINTW1FN _0x0,22
	ST   -Y,R31
	ST   -Y,R30
	LDS  R30,_rx_buffer
...
_0x11:
; 0000 007E     {
; 0000 007F      if((rx_buffer[0] == '*'))// && (rx_buffer[1] == '*'))
	LDS  R26,_rx_buffer
	CPI  R26,LOW(0x2A)
	BRNE _0x14
; 0000 0080         {
; 0000 0081           //  usart_msg("data nhiet do");
; 0000 0082              twi_lcd_cmd(0xC0);
	LDI  R26,LOW(192)
	RCALL _twi_lcd_cmd
; 0000 0083              twi_lcd_msg("nhiet do TRUYEN: \r\n");
	__POINTW2MN _0x10,19
	RCALL _twi_lcd_msg
; 0000 0084             twi_lcd_dwr(rx_buffer[2] + 48);
	__GETB2MN _rx_buffer,2
	SUBI R26,-LOW(48)
	RCALL _twi_lcd_dwr
; 0000 0085             twi_lcd_dwr(rx_buffer[3] + 48);
...
; 0000 0086             twi_lcd_dwr(46);
	LDI  R26,LOW(46)
	RCALL _twi_lcd_dwr
; 0000 0087             twi_lcd_dwr(rx_buffer[4] + 48);
	__GETB2MN _rx_buffer,4
	SUBI R26,-LOW(48)
	RCALL _twi_lcd_dwr
; 0000 0088 
; 0000 0089         }
; 0000 008A       else if(rx_buffer[0] != '*')
	RJMP _0x15
_0x14:
	LDS  R26,_rx_buffer
	CPI  R26,LOW(0x2A)
	BREQ _0x16
; 0000 008B          {
; 0000 008C           rx_wr_index =0;
	CLR  R4
; 0000 008D          // usart_msg("data clear buffer");
; 0000 008E            rx_buffer[0] =0;
	LDI  R30,LOW(0)
	STS  _rx_buffer,R30
; 0000 008F            rx_buffer[1] =0;
	__PUTB1MN _rx_buffer,1
; 0000 0090            rx_buffer[2] =0;
	__PUTB1MN _rx_buffer,2
; 0000 0091            rx_buffer[3] =0;
	__PUTB1MN _rx_buffer,3
; 0000 0092            rx_buffer[4] =0;
